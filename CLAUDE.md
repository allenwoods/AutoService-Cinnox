...
This repo is an **L3 fork** of [AutoService upstream](https://github.com/ezagent42/AutoService).

| Layer | Upstream | This Repo (L3 Cinnox) |
|-------|----------|-----------------------|
| L1 | `h2oslabs/socialware` | `socialware/` (read-only, from upstream) |
| L2 | `ezagent42/AutoService` | `autoservice/`, `channels/`, `skills/` (from upstream) |
| L3 | — | `plugins/cinnox/`, `skills/cinnox-demo/`, customer data |
