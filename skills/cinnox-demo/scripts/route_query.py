#!/usr/bin/env python3
"""
Query Router — keyword-based routing for cinnox-demo queries.
...
Usage:
    uv run .claude/skills/cinnox-demo/scripts/route_query.py --query "US DID pricing"
    uv run .claude/skills/cinnox-demo/scripts/route_query.py --query "CINNOX WhatsApp integration"
    uv run .claude/skills/cinnox-demo/scripts/route_query.py --query "What is DID?"
"""
