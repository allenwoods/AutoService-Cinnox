#!/usr/bin/env python3
"""
Get a record from the customer service database.

Usage:
    uv run scripts/get_record.py --type customer --name '张先生'
...
def main():
    parser = argparse.ArgumentParser(description='Get a record from the customer service database')
