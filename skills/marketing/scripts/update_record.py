#!/usr/bin/env python3
"""
Update a record in the marketing database.

Usage:
    uv run scripts/update_record.py --type customer --name '王建华' --updates '{"phone": "13800138001"}'
    uv run scripts/update_record.py --type product --id 'abc123' --updates '{"price": "9999元/年"}'
"""
...
def main():
    parser = argparse.ArgumentParser(description='Update a record in the marketing database')
