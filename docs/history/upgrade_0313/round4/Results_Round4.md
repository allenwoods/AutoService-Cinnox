# CINNOX UAT — Round 4 Test Results
...
> **Round 4**: Post-upgrade regression test. KB re-ingested with semantic chunking (547 chunks, up from 387). Testing existing 19 TCs for regression before new domain/region test cases.
